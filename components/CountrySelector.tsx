  ...
  return (
    <div className="flex items-center gap-2">
      ...
      <Select.Root value={selectedCountry} onValueChange={(value: 'SG' | 'MY') => setSelectedCountry(value)}>
        <Select.Trigger
          id="country-select"
          className="inline-flex items-center justify-center rounded-lg bg-gray-100 px-4 py-2 text-sm font-medium text-gray-700 hover:bg-gray-200 focus:outline-none focus:ring-0"
