  ...
  return (
    <div className={`relative ${className}`}>
      <button
        ...
        className="flex items-center gap-1.5 px-3 py-1.5 text-xs font-medium text-ink-600 bg-paper-100 border border-ink/10 rounded-lg hover:bg-paper-200 hover:border-ink/15 transition-colors"
      ...
      {open && (
        <>
          ...
          {/* Dropdown */}
          <div className="absolute right-0 top-full mt-2 w-72 bg-paper-100 border border-ink/10 rounded-card shadow-lg z-50 overflow-hidden">
            {/* Preview card */}
            <div className="bg-paper-200 p-4 border-b border-ink/10">
              <p className="text-xs font-semibold text-brand-600 mb-1">battery.mom</p>
            ...
            <div className="p-3 space-y-2">
              ...
              <button
                onClick={handleCopy}
                className="w-full flex items-center gap-2 px-3 py-2 text-sm text-ink-700 hover:bg-paper-200 rounded-lg transition-colors"
              >
                {copied ? (
              ...
              {/* Social links */}
              <div className="flex gap-2 pt-1 border-t border-ink/5">
                <a
                  href={twitterUrl}
                  target="_blank"
                  rel="noopener noreferrer"
                  className="flex-1 flex items-center justify-center gap-1 px-2 py-1.5 text-xs text-ink-600 hover:bg-paper-200 rounded-lg transition-colors"
                  title="Share on X"
                >
