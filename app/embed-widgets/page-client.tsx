...
export default function EmbedPageClient() {
  ...
  return (
    <main className="min-h-screen bg-gradient-to-br from-gray-50 to-emerald-50/30 py-12 px-4">
      <div className="max-w-5xl mx-auto">
        {/* Header */}
        <div className="text-center mb-10">
          <h1 className="text-3xl sm:text-4xl font-bold text-gray-900 mb-3">
            Embed <span className="text-emerald-600">battery.mom</span> Widgets
          </h1>
          ...
          {WIDGETS.map((w) => (
            <button
              ...
              className={`text-left p-4 rounded-xl border-2 transition-all ${
                selected === w.id
                  ? 'border-emerald-500 bg-white shadow-md ring-1 ring-emerald-200'
          ...
          <div className="space-y-6">
            <div>
              ...
              <div className="grid grid-cols-2 gap-4">
                <label className="block">
                  <span className="text-xs font-medium text-gray-600">Width (px)</span>
                  <input
                    type="number"
                    value={width}
            ...
            <div>
              ...
              <div className="relative">
                <pre className="bg-gray-900 text-emerald-400 text-xs p-4 rounded-xl overflow-x-auto font-mono leading-relaxed whitespace-pre-wrap break-all">
                  {embedCode}
                </pre>
                <button
                  onClick={handleCopy}
            ...
            <div className="bg-emerald-50 rounded-xl p-4 border border-emerald-200">
              <h3 className="text-sm font-semibold text-emerald-800 mb-2">Usage Guidelines</h3>
